...
<body class="bg-gray-50">
	...
	<footer class="bg-gray-800 text-white py-8">
		<div class="container mx-auto px-6">
			<h4 class="text-lg font-bold mb-4 text-center">Ingeniería de Software</h4>
			<p class="text-gray-400 text-center">Ingeniería de Software</p>
			<div class="border-t border-gray-700 mt-8 pt-8 text-sm text-center">
				<p>&copy; 2024 Universidad de El Salvador. Brandon Daniel Parrillas.</p>
			</div>
		</div>
	</footer>
